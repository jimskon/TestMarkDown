...
E. Howtoverifyandvalidatesoftware.
...
| **Topic** | **Notes Links Readings** | **Quiz** | **Slides** | **Assignment Due** | **Team Assignments Due** |
| --- | --- | --- | --- | --- | --- |
| Introduction | 100 Interview Questions for Software Developers |   | Ch1.pptx |   |   |
| **Lab** : Project presentations |   | Link |   |   |   |
| **Software Processes** :
Software process models
Process activities | Chapter 2 Homework: 2.1, 2.2, 2.3 on page 54 | Link | Ch2.pptx |   |   |
| **Software Processes** :
Coping with change
The rational unified process |   | Link |   |   |
| Agile software development | Update Wiki with test plan and Risk Assessment | Chapter 3 Homework 3.1, 3.5 3.6, 3.8 on page 78 | Link | Ch3.pptx | 2.1, 2.2, 2.3 on page 54Resume on wiki |
